...
extract_values = message_conversion.extract_values  # type: Callable[[rclpy.Message], Dict]
populate_instance = message_conversion.populate_instance  # type: Callable[[Dict, rclpy.Message], rclpy.Message]
